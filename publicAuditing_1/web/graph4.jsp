<%-- 
    Document   : graph4
    Created on : 17 Jul, 2017, 3:34:53 PM
    Author     : sagar
--%>
...
Connection conn = null;
			...
			Statement st =conn.createStatement();
                        ...
                        //ResultSet rs = st.executeQuery("select * from recommend where uname='"+user+"'");
                                    ...
                                    ResultSet rs = st.executeQuery("select * from satime LIMIT 3");
                                    while(rs.next())
                                    {
...
try {
    ...
    for(int i=0;i<s1.size();i++) {
         ...
         double aa = Double.parseDouble(a)*1000;
    ...
    System.out.println("values"+ cr1.length);
                       XYChart c = new XYChart(600,350); //750, 600
                        ...
                        BarLayer layer=c.addBarLayer(Chart.Side,2);
                       layer.addDataSet(cr1,0xff8080,"servser-1");
                        layer.addDataSet(cr2,0x80ff80,"servser-2");
