...
<script type="text/javascript">  
    function save1() {
        var fnames  = document.form1.role1.value;
        alert(fnames);
        document.form1.action = "./aduit1";
...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="" style="background:lightblue">
   <div class="codrops-top clearfix">				
                                ...
                                <a href="#" onclick="call()"><strong>audit</strong></a> 
    ...
    Connection conn = null;
			...
			Statement st =conn.createStatement();
                        ...
                        //ResultSet rs = st.executeQuery("select * from recommend where uname='"+user+"'");
                                    ...
                                    ResultSet rs = st.executeQuery("select * from lblock");
                                    while(rs.next())
                                    {
                                        System.out.println("-------myrecomends----->");
                                        
                                           
                                           String grname=rs.getString("fname");
                                           if(!fnames.contains(grname))
    {
                                         fnames.add(grname);
                                      System.out.println("-------myrecomends----->"+grname);
 }
  		            ...
  		            {
                                String k=fnames.get(i).toString();
                                System.out.println("k:"+k);
  		            %> 
                          <option value="<%=k%>"><%=fnames.get(i)%></option>
                              <%}%> 
                          </select>             
                          <div>
                            
                            <input type="submit" value="audit" onclick="save1()"/>
