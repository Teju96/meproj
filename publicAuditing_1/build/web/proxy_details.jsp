...
{
       alert(a+b);
       document.form1.f.value = a;
       document.form1.s.value = b;
        document.form1.action = "./verify";
  ...
  function save3(a,b)
{
    ...
    { 
       ...
       document.form1.action = "./pkeysending";
       document.form1.submit();
       alert("thank u");
    }
    function product(x,y) {
    	document.form1.product.value = x;
    	document.form1.price.value = y;
...
if(fn=="" || ln=="" || un=="" || pwd=="" || em=="" || cn=="" || addr=="" || role=="" ) {
    alert("Please Fill the informations");    
    }

if(!filter.test(em)) {
	alert("Ener a valid email id");
}
else if(isNaN(cn))
{
...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="" style="background:lightblue">
   <div class="codrops-top clearfix">				
                                <a href="#"><strong>userdetails </strong></a>
                                <a href="#" onclick="call()"><strong>delegation</strong></a> 
                                <a href="#" onclick="call1()"><strong>verify</strong></a> 
                                  <a href="#" onclick="call2()"><strong>fverify</strong></a>  
                                  <a href="index.jsp"><strong>logout</strong></a> 
			</div>
			<header class="clearfix">      
                            <img src="images/im.jpg" width="120" height="76" align="left"/>
                            <br>                            
        ...
        <form name="form1" method="post">
           <fieldset id="analysis" style="display:inline;">
             ...
             <fieldset id="analysis1" style="display:none;">
                <legend>User Delegation Details</legend>
                                  ...
                                  <%
                                       try{  
                                    	   ...
                                    	   Class.forName(driver).newInstance();
                                    	    connection = DriverManager.getConnection(url+dbName,userName,dpassword);
                                    	    statement = (Statement) connection.createStatement();
                                           rs=statement.executeQuery("select * from dkey");
                                           while(rs.next())
                                           {
                                               System.out.println("-------myrecomends----->");
                                  ...
                                  <%
                                       try{  
                                    	   ...
                                    	   Class.forName(driver).newInstance();
                                    	    connection = DriverManager.getConnection(url+dbName,userName,dpassword);
                                    	    statement = (Statement) connection.createStatement();
                                           rs=statement.executeQuery("select * from repair");
                                           while(rs.next())
                                           {
                                               System.out.println(rs.getString("sname")+"-------myrecomends****----->"+rs.getString("fname"));
                                    ...
                                    <tr>
                                         ...
                                         <td> <input type="submit" value="verify1" onclick="save2('<% request.setAttribute("fn", rs.getString("fname")); request.setAttribute("sname", rs.getString("sname"));%> <%=request.getAttribute("fn")%>','<%=request.getAttribute("sname")%>')"></td>
              ...
              <fieldset id="analysis3" style="display:none;">
                <legend>Fbooking details</legend>
                <table class="CSSTableGenerator" align="left">
                                       <th>fname</th>
                                       <th>servername</th>
                                       <th>verify</th>
                                  ...
                                  <%
                                    ...
                                    <tr>
                                         ...
                                         <td> <input type="submit" value="verify" onclick="save3('<% request.setAttribute("fn", rs.getString("fname")); request.setAttribute("sname", rs.getString("sname"));%> <%=request.getAttribute("fn")%>','<%=request.getAttribute("sname")%>')"></td>
