...
Connection conn = null;
			...
			Statement st =conn.createStatement();
                        ...
                        //ResultSet rs = st.executeQuery("select * from recommend where uname='"+user+"'");
                                    ...
                                    ResultSet rs = st.executeQuery("select * from audittime1 LIMIT 25");
                                    while(rs.next())
                                    {
...
try {
    ...
    for(int i=0;i<s1.size();i++) {
         ...
         double aa = Double.parseDouble(a)*100;
                      ...
                      // c.setPlotArea(50, 25,600,250, 0xffffc0, 0xffffe0);
                       ...
                       c.addLegend(55, 18, false, "",10).setBackground(Chart.Transparent);
                         BarLayer layer=c.addBarLayer(Chart.Side,2);
                          layer.addDataSet(cr2,0x80ff80,"indivual audit");
                        ...
                        c.xAxis().setTitle("Number of sampled segments", "Arial Bold Italic", 12);
